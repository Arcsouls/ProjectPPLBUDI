      ...
      <div class="container">
        <div class="row">
          <div class="col-md-6 offset-md-3">
            <h2 style="text-align: center; color: white;">Upload perijinan</h2>
            <p style="text-align: center; color: white; padding-bottom: 100px;">Di dalam halaman ini anda dapat mengupload data data yang dibutuhkan dalam perijinan SIMAKSI</p>
            @if(count($errors) > 0)
            ...
            <form action="{{url('/izin/proses')}}" method="POST" enctype="multipart/form-data">
              {{ csrf_field() }}
              
              <div class="form-group">
                <b>Nama</b><br/>
                <input type="text" name="nama" value="{{Auth::user()->name.' '.Auth::user()->nama}}" disabled>
              </div>

              <div class="form-group">
                <b>Surat Keterangan Dari Kampus/Kepolisian</b><br/>
                <input type="file" name="desa">
              </div>

              <div class="form-group">
                <b>Surat Keterangan Sehat</b><br/>
          ...
          <table class="table table-bordered table-striped" style="color: white; border: solid; text-align: center;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$I->keterangan}}</td>
                <td><a class="btn btn-danger" href="{{url('/izin/hapus/'.$I->id)}}">HAPUS</a></td>
              </tr>
              @endforeach
            </tbody>
          </table>
